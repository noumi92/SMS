...
public class TuitionsListActivity extends AppCompatActivity implements TuitionListViewInterface{
    private String TAG = "com.noumi.sms.custom.log";
    private TuitionListPresenterInterface mTuitionsListPresenter;
    private RecyclerView mTuitionsRecyclerView;
    private TuitionAdapter mTuitionAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mTuitionsRecyclerView.setLayoutManager(new LinearLayoutManager(this));
    ...
    @Override
    public void onLoadComplete(List<Tuition> tuitions) {
        Log.d(TAG, "data result count:" + tuitions.size());
        if (mTuitionAdapter == null) {
            mTuitionAdapter = new TuitionAdapter(this, tuitions);
            mTuitionsRecyclerView.setAdapter(mTuitionAdapter);
        } else {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        if(item.getItemId() == R.id.logout_item){
            mTuitionsListPresenter.logoutUser();
            startActivity(new Intent(TuitionsListActivity.this, LoginActivity.class));
        }
        return true;
    }
